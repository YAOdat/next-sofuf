...
import { Link, Card, Button, Pagination } from "@nextui-org/react";
...
export default function CareersPage() {
  ...
  const ITEMS_PER_PAGE = 10; // Limit jobs per page
  ...
  const paginatedCareers = careersData
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <Pagination
        initialPage={1}
        total={Math.ceil(careersData.length / ITEMS_PER_PAGE)}
