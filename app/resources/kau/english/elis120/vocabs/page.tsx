...
export const metadata: Metadata = {
    title: 'الكلمات المطلوب حفظها في الاختبار النصفي - جامعة الملك عبد العزيز',
    keywords: 'اللغة الإنجليزية، جامعة الملك عبد العزيز، انقلش جامعة الملك عبد العزيز، فوكاب النصفي جامعة الملك عبد العزيز، معهد اللغة الإنجليزية جامعة الملك عبد العزيز.',
    description: 'الكلمات المطلوب حفظها في الاختبار النصفي لجامعة الملك عبد العزيز المستوى الثاني علمي',
    robots: 'index, follow',
}
...
export default function Vocabs() {
    return (
        ...
        `}
            ...
            <h1 className="my-2">الكلمات المطلوب حفظها في الاختبار النصفي <br /> المستوى الثاني - علمي</h1>
