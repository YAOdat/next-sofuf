        ...
        <CardBody>
          <article className="max-w-full md:max-w-3xl lg:max-w-4xl mx-auto">
            ...
            <div className="max-w-full md:max-w-2xl mx-auto">
              ...
              Arabic Telegram Group:<br /><Code className="text-blue-500 break-words bg-cyan-900 mt-4" ><Link href="https://t.me/ArabicDiscussionGroup" style={{ fontSize: '12px', color: 'cyan' }} target="_blank" rel="noopener noreferrer">https://t.me/ArabicDiscussionGroup</Link>
              </Code>
            </div>
